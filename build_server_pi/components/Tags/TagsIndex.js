...
var TagsIndex = function (_React$Component) {
  ...
  function TagsIndex(props) {
    ...
    _this.state = {};
    _this.props.dispatch((0, _actions.tagsAction)());
    return _this;
  }
  ...
  _createClass(TagsIndex, [{
    ...
    value: function render() {
      ...
      var tags = [];
      this.props.tagsList.map(function (tag, index) {
        tags.push(_react2.default.createElement(
          'li',
          { key: index },
          _react2.default.createElement(
            _reactRouter.Link,
            { to: _App.AppRouter.tagLink(tag.name_seo) },
            tag.name
          )
        ));
      });
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(TagsIndex);
//# sourceMappingURL=TagsIndex.js.map